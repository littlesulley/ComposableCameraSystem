...
namespace ComposableCameraSystem::ShotEditorWheelMath
{
	 ...
	 *   - Shift:   50% step → factor 1.50  (5× default — fast traversal)
	 *   - Ctrl:    2%  step → factor 1.02  (0.2× default — fine framing)
	 *   - Shift+Ctrl: default — composing 5× and 0.2× gives 1× (≡ default),
...
private:
	 ...
	 *  pattern as the LMB handle drag (TechDoc §7.2 Sequencer-respawn flash):
	 ...
	 * `0.5° * DeltaX` into `Shot.Roll`, wraps via `UnwindDegrees`, and
