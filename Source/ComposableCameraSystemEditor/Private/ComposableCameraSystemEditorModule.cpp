...
void FComposableCameraSystemEditorModule::StartupModule()
{
    ...
    // instead of falling back to 1920×1080. Without this, the Composition
    ...
    // through the live Sequencer instance for the section's sequence.
    {
        ...
        SequencerCreatedHandle = SequencerModule.RegisterOnSequencerCreated(
            FOnSequencerCreated::FDelegate::CreateRaw(this, &FComposableCameraSystemEditorModule::OnSequencerCreated));
    }
}
...
void FComposableCameraSystemEditorModule::RegisterSequencerTrackEditor()
{
    ...
    ShotTrackEditorHandle = SequencerModule.RegisterTrackEditor(
        FOnCreateTrackEditor::CreateStatic(
