 ...
 * accepts them; without that flag the menu silently collapses (TechDoc §7.2
 * gotcha).
 *
 ...
 */
class FComposableCameraPatchSectionInterface
	: public ISequencerSection
	, public TSharedFromThis<FComposableCameraPatchSectionInterface>
{
public:
