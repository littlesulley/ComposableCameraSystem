...
void FShotPlacementCustomization::Register(FPropertyEditorModule& PropertyEditorModule)
{
	PropertyEditorModule.RegisterCustomPropertyTypeLayout(
		FShotPlacement::StaticStruct()->GetFName(),
...
void FShotPlacementCustomization::CustomizeHeader(
...
void FShotPlacementCustomization::CustomizeChildren(
	TSharedRef<IPropertyHandle> StructPropertyHandle,
		...
		if (PropName == GET_MEMBER_NAME_CHECKED(FShotPlacement, BasisActorIndex))
		{
			...
			TAttribute<EVisibility> VisAttr =
				TAttribute<EVisibility>::CreateLambda([WeakStruct]() -> EVisibility
				{
					...
					TSharedPtr<IPropertyHandle> BasisHnd = Pin->GetChildHandle(
						GET_MEMBER_NAME_CHECKED(FShotPlacement, BasisFrame));
