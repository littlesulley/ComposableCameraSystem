...
{
	PropertyEditorModule.RegisterCustomClassLayout(UComposableCameraPatchTypeAsset::StaticClass()->GetFName(),
...
void FComposableCameraPatchTypeAssetCustomization::Unregister(FPropertyEditorModule& PropertyEditorModule)
{
	...
	{
		PropertyEditorModule.UnregisterCustomClassLayout(UComposableCameraPatchTypeAsset::StaticClass()->GetFName());
	}
}
...
void FComposableCameraPatchTypeAssetCustomization::CustomizeDetails(IDetailLayoutBuilder& DetailBuilder)
{
	...
	DetailBuilder.HideProperty(GET_MEMBER_NAME_CHECKED(UComposableCameraTypeAsset, EnterTransition),
		UComposableCameraTypeAsset::StaticClass());
	DetailBuilder.HideProperty(GET_MEMBER_NAME_CHECKED(UComposableCameraTypeAsset, ExitTransition),
		UComposableCameraTypeAsset::StaticClass());
	DetailBuilder.HideProperty(GET_MEMBER_NAME_CHECKED(UComposableCameraTypeAsset, bDefaultPreserveCameraPose),
		UComposableCameraTypeAsset::StaticClass());
}
