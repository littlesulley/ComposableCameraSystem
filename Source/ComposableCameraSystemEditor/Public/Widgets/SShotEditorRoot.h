 ...
 */
class COMPOSABLECAMERASYSTEMEDITOR_API SShotEditorRoot
	: public SCompoundWidget
	, public FNotifyHook   // bridges struct-detail-view edits to host UObject's
...
private:
	 ...
	 *  CameraTypeAsset / standalone-ShotAsset case. See §23.12 of EditorDesignDoc. */
	...
	// — see EditorDesignDoc §23.1). The toolbar walks the active host's
	...
	TSharedRef<ITableRow> MakeShotListRow(
	...
	void OnShotListMouseButtonClick(
	 ...
	 *  is cheap (handful of sections in a typical LS) but doing it 60×
