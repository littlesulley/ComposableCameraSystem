...
private:
	...
	void SyncPhase_CollectGraphNodes(TArray<UComposableCameraNodeGraphNode*>& OutCameraGraphNodes,
	...
	void SyncPhase_SnapshotOldTemplateIndices(TMap<int32, UComposableCameraCameraNodeBase*>& OutOldIndexToTemplate) const;
	 ...
	 * in phase 8. */
	void SyncPhase_RebuildNodeTemplatesAndPositions(const TArray<UComposableCameraNodeGraphNode*>& GraphNodes,
	...
	void SyncPhase_RebuildComputeTemplatesAndPositions(const TArray<UComposableCameraNodeGraphNode*>& ComputeGraphNodes,
	...
	void SyncPhase_RebuildPinConnections(const TArray<UComposableCameraNodeGraphNode*>& GraphNodes);
	...
	void SyncPhase_RebuildComputePinConnections(const TArray<UComposableCameraNodeGraphNode*>& ComputeGraphNodes);
	...
	void SyncPhase_RebuildVariableNodeRecords(const TArray<UComposableCameraVariableGraphNode*>& VariableGraphNodes);
	...
	void SyncPhase_MigrateExposedParameters(const TMap<int32, UComposableCameraCameraNodeBase*>& OldIndexToTemplate,
	...
	void SyncPhase_RebuildNodePinOverrides(const TArray<UComposableCameraNodeGraphNode*>& GraphNodes);
	 ...
	 * iteration order. */
	void SyncPhase_RebuildComputeNodePinOverrides(const TArray<UComposableCameraNodeGraphNode*>& ComputeGraphNodes);
	...
	void RebuildPhase_CreateCameraGraphNodes(TArray<UComposableCameraNodeGraphNode*>& OutCreatedGraphNodes);
	...
	void RebuildPhase_CreateComputeGraphNodes(TArray<UComposableCameraNodeGraphNode*>& OutCreatedComputeGraphNodes);
	...
	void RebuildPhase_RestoreCameraNodePinConnections(const TArray<UComposableCameraNodeGraphNode*>& CreatedGraphNodes);
	...
	void RebuildPhase_RestoreComputeNodePinConnections(const TArray<UComposableCameraNodeGraphNode*>& CreatedComputeGraphNodes);
