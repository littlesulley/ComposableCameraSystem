...
public:
	...
	virtual void GetContextMenuActions(
		class UToolMenu* Menu, class UGraphNodeContextMenuContext* Context) const override;
...
private:
	...
	static void BuildPinContextMenuActions(
		UToolMenu* Menu,
	...
	static void BuildNodeContextMenuActions(
		UToolMenu* Menu,
	...
	static void BuildCameraNodePaletteActions(
	...
	static void BuildComputeNodePaletteActions(
		FGraphContextMenuBuilder& ContextMenuBuilder);
	...
	static void BuildVariablePaletteActions(
		FGraphContextMenuBuilder& ContextMenuBuilder,
