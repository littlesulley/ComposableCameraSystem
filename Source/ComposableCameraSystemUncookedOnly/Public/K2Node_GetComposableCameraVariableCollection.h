...
#include "K2Node_GetComposableCameraVariableCollection.generated.h"
...
/**
 * K2 Node to get runtime values of a composable camera variable collection.
 */
UCLASS(ClassGroup = ComposableCameraSystem)
class COMPOSABLECAMERASYSTEMUNCOOKEDONLY_API UK2Node_GetComposableCameraVariableCollection
...
public:
	...
	void RemoveVariablePin(const UEdGraphPin* VariablePin);
