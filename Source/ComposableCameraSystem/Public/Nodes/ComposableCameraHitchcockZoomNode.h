...
public:
	 ...
	 *  false (or the bone can't be found). Typical 50�?0 to land on chest
	...
	/** Additive distance delta (world units) over normalized time. X �?	 *  [0, 1], Y is DELTA from InitialDistance �?author Y(0) = 0. Positive
